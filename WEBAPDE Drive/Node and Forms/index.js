...
//    else{
//        
//        resp.render('./pages/wrong',{data: data});
//    }
    var data = {lastname: req.body.lastname[0], firstname: req.body.firstname[0], middlename: req.body.middlename[0], bday: req.body.bday[0]};
        resp.render('.pages/answer', {data: data});
});
